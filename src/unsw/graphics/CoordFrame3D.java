...
public class CoordFrame3D {
    ...
    public Vector4 getDirectionInFrame(Vector4 direction){
    	return matrix.multiply(direction);
    } 
    
    public CoordFrame3D rotateDirection(Vector4 direction){
    	return new CoordFrame3D(matrix.rotateDirection(direction));
    }
    
    public CoordFrame3D rotateByFrame(Matrix4 m){
    	return new CoordFrame3D(matrix.multiply(m));
    }
